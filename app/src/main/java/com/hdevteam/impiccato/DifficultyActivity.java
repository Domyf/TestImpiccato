...
public class DifficultyActivity extends AppCompatActivity {
    ...
    public void loadSave() {
        ...
        Log.i("DifficultyActivity", "Best Score Facile: "+save.getBestScoreEasy()+"    Riga Best Score Media: "+save.getBestScoreMedium()+"    Riga Best Score Difficile: "+save.getBestScoreHard());
